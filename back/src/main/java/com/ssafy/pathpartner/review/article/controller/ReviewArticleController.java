package com.ssafy.pathpartner.review.article.controller;
...
import com.ssafy.pathpartner.review.article.service.ReviewArticleService;
...
public class ReviewArticleController {
    ...
    public ResponseEntity<?> getArticle(
        ...
        try {
            ReviewArticleDto reviewArticleDto = reviewArticleService.getArticle(String.valueOf(reviewArticleNo));
